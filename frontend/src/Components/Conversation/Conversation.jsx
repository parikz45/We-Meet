...
function Conversation({ message, self, onReply }) {
    ...
    useEffect(() => {
        const getData = async () => {
            try {
                const res = await axios.get(`https://we-meet-9jye.onrender.com//api/users?userId=${message.sender}`);
                            ...
                            {message.audio && (
                                <div className="audio-wrapper">
                                    <audio controls className="audio-player">
                                        <source src={"https://we-meet-9jye.onrender.com//api/messages/audio/" + message.audio} type="audio/webm" />
