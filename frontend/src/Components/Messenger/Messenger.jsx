...
function Messenger() {
    ...
    useEffect(() => {
        const fetchSender = async () => {
            if (replyMessage) {
                try {
                    const res = await axios.get(`https://we-meet-production.up.railway.app/api/users?userId=${replyMessage.sender}`);
    ...
    useEffect(() => {
        const getConversations = async () => {
            try {
                const res = await axios.get("https://we-meet-production.up.railway.app/api/conversations/" + user._id);
    ...
    useEffect(() => {
        const getMessages = async () => {
            try {
                const response = await axios.get("https://we-meet-production.up.railway.app/api/messages/" + currentChat?._id);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post("https://we-meet-production.up.railway.app/api/messages/", message);
    ...
    const handleFriendClick = async (friend) => {
        ...
        if (existing) {
            ...
            try {
                const res = await axios.post("https://we-meet-production.up.railway.app/api/conversations", {
                    senderId: user._id,
