...
function Share() {
  ...
  const submitHandler = async (e) => {
    ...
    if (file) {
      ...
      try {
        const res = await axios.post("https://we-meet-production.up.railway.app/api/upload", data);
    ...
    try {
      await axios.post("https://we-meet-production.up.railway.app/api/posts", newPost);
