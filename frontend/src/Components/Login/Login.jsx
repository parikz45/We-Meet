          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgotPassword" className="text-xs text-indigo-600 hover:text-indigo-700 transition">
                  Forgot password?
                </Link>
              </div>
              <input
            ...
            <button
              ...
              className="mt-1 h-10 rounded-lg bg-indigo-600 text-white text-sm font-medium
                         ...
                         disabled:opacity-60 flex items-center justify-center cursor-pointer"
            >
              {isFetching ? <CircularProgress color="inherit" size="18px" /> : "Sign in"}
            </button>
